...
<div class="container-fluid bg-overlay" id="gambar">
  <div class="row text-center">
    ...
    <a href="index.php?page=obat"><button type="button" class="btn btn-explore btn-lg btn3d"></span>Mulai Mencari <i class="bi bi-arrow-up-right-square p-1"></i></i></button></a>
    </div>
  </div>
</div>
    ...
    <div class="row justify-content-center baris1">
      <div class="col-sm-3">
        <div class="card-home h-100"
          style="margin-top: 20px; height: auto; min-height: 430px; width: 100%; border-radius: 5%;">
          <div class="card-header border-0">
            <img src="assets/images/vaksinasi.jpeg" class="img-fluid card-img-top" alt="vaksinasi"
      ...
      <div class="col-sm-3">
        <div class="card-home h-100"
          style="margin-top: 20px; height: auto; min-height: 430px; width: 100%; border-radius: 5%;">
          <div class="card-header border-0">
            <img src="assets/images/checkup.jpeg" class="img-fluid card-img-top" alt="checkup"
              style="height: 300px; border-radius: 10%;">
          </div>
          <div class="card-body text-center" style="background-size: cover;">
      ...
      <div class="col-sm-3">
        <div class="card-home h-100"
          style="margin-top: 20px; height: auto; min-height: 430px; width: 100%; border-radius: 5%;">
          <div class="card-header border-0">
            <img src="assets/images/delivery.jpeg" class="img-fluid card-img-top" alt="delivery"
              style="height: 300px; border-radius: 10%;">
          </div>
          <div class="card-body text-center" style="background-size: cover;">
...
<section id="showoff-1">
  <div class="container my-4" id="WhyChoose">
      <div class="img-col">
      ...
      <div class="text-col">
        ...
        <p>ApoteKrw telah menjadi apotek dengan kredibitas tinggi yang didukung oleh Ikatan Kedokteran indonesia.
          ...
          kami.</p>
        <br>
        <button type="button" class="btn btn-primary rounded-pill">Tahu lebih lanjut</button>
    </div>
  </div>
</section>